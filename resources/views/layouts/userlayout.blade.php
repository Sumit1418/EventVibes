    ...
    <nav class="navbar">
      <ul>
        <li class="nav-item active">
          <a class="nav-link" href="/user/home"><i class="fa-solid fa-house"></i></a>
        </li>
        <li class="nav-item">
    ...
    <div class="profile-content">
      ...
      <div class="profile-body">
        <div class="profile-picture">
          <img
            src="{{ asset('storage/'.$_SESSION['userDetails']->profile_path) }}"
            alt="Profile Picture"
          />
        </div>
        ...
        <div class="profile-options">
          <a href="/user/userdetails" class="profile-option">
      ...
      <div class="notif-body">
        <div class="notif-item">
          ...
          <div class="notif-text">
            <p>Booking confirmed for shivaji caterers</p>
          </div>
        </div>
      </div>
    </div>
