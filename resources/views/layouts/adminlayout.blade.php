    ...
    <nav class="navbar">
      <ul>
        <li class="nav-item active">
          <a class="nav-link" href="/admin/dashboard"><i class="fa-solid fa-house"></i></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/admin/approvecompany">
    ...
    <div class="profile-content">
      ...
      <div class="profile-body">
        <div class="profile-picture">
          <img
            src="{{ asset('storage/default_picture/default_picture.jpg') }}"
            alt="Profile Picture"
          />
        </div>
        ...
        <div class="profile-options">
          <a href="/company/companydetails" class="profile-option">
            <i class="fas fa-edit"></i> Create Admin
          </a>
      ...
      <div class="notif-body">
        <div class="notif-item">
          ...
          <div class="notif-text">
            <p>Sjivaji Decorator requested for Approval</p>
          </div>
        </div>
      </div>
    </div>
